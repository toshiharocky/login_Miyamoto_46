...
(7, 'アスカ', 'second_child', 'antabaka?', 0, 0),
(8, 'ゲンドウ', 'ikari-shirei', 'yuigasuki', 1, 0),
(9, 'トウジ', 'kansaijin', 'sakurainochi', 0, 1),
(10, 'ミサト', 'misato-katsuragi', 'chocchine', 1, 1);
...
(42, 'supplements', '001-084312', 'グリコ　クレアチン', '2021-04-14 11:30:11', 5, 'シンジ', 'waiting', NULL, NULL);
...
('001-084312', 'supplements', 'グリコ　クレアチン', 100, 15, 85, 5, 70, '2021-04-06 15:27:28'),
